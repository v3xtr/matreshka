...
class Transport {
    constructor(opts) {
        ...
        this[symbols_1.kHeaders] = Object.assign({}, { 'user-agent': userAgent }, (opts.enableMetaHeader == null ? true : opts.enableMetaHeader) ? { 'x-elastic-client-meta': `et=${clientVersion},js=${nodeVersion}` } : null, opts.compression === true ? { 'accept-encoding': 'gzip,deflate' } : null, lowerCaseHeaders(opts.headers));
        ...
        while (meta.attempts <= maxRetries) {
            ...
            try {
                ...
                if (headers['content-type'] !== undefined &&
                    (((_22 = headers['content-type']) === null || _22 === void 0 ? void 0 : _22.includes('application/json')) ||
                        ((_23 = headers['content-type']) === null || _23 === void 0 ? void 0 : _23.includes('application/vnd.elasticsearch+json'))) &&

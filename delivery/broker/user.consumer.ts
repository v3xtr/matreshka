...
const QUEUE = "feed.user.created";
const RETRY_QUEUE = "feed.user.created.retry";
const DLQ = "feed.user.created.dlq";
const RETRY_LIMIT = 5;
const RETRY_TTL = 5000;

export class RabbitUserConsumer implements IRabbitConsumer {

...
public class ProductsController {
    ...
    @PutMapping
    public ResponseEntity<AdvertUpdateRequestDTO> update(
            @Valid @RequestBody AdvertUpdateRequestDTO advertUpdateRequestDTO,
            @AuthenticationPrincipal String userId
    ) {
        AdvertUpdateRequestDTO advert = productsService.update(advertUpdateRequestDTO, userId);
    ...
    @PreAuthorize("#userId == authentication.principal")
    @PatchMapping
    public ResponseEntity<Void> updateAdvertVideo(
            UpdateVideoInAdvertRequestDTO updateVideoInAdvertRequestDTO,
            @AuthenticationPrincipal String userId
    ) {
        productsService.updateVideoId(updateVideoInAdvertRequestDTO, userId);
